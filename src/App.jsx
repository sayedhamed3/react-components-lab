...
const App = () => {
  ...
  return (
    <>
      <h1>Local Weather</h1>
      <section>
        {weatherForecasts.map((oneForecast) => (
          <div key={oneForecast.day}> 
            <WeatherForecast day={oneForecast.day} img={oneForecast.img}
            imgAl={oneForecast.imgAlt} conditions={oneForecast.conditions} time={oneForecast.time} />
          </div>
        ))}
      </section>
    </>
